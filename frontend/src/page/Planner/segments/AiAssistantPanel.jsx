...
const AiAssistantPanel = () => {
  ...
  const getQuickActions = () => {
    ...
    // 預設的「目的地模式」按鈕
    return [
      { label: '🌍 想換個城市', prompt: '我改變主意了，我想換去別的城市旅遊，請給我一些不同的城市提案！' },
      { label: '🏨 推薦住宿', prompt: '請用文字跟我討論一下，這個城市有哪些推薦的住宿區域或飯店？' },
      { label: '🍜 推薦美食', prompt: '請推薦這個城市的在地必吃美食，先不用幫我排進行程裡。' },
      { label: '🔄 重新規劃', prompt: '這個行程不太順，請幫我重新產生 3 個新的風格提案。' },
    ];
  };
