    ...
    <div className="az-proposal-view">
      ...
      <div className="az-proposal-scroll-area">
        {proposals.map((p, index) => {
          ...
          const previewItems = Array.isArray(data?.days?.[0]?.items)
            ? data.days[0].items.slice(0, 3)
            : [];
          const highlights = Array.isArray(p.highlights) ? p.highlights.slice(0, 3) : [];
