...
function App() {
  ...
  const handleSend = async () => {
    ...
    try {
      const res = await fetch('https://travel-planner-api-623573920079.asia-east1.run.app/api/chat', {
        method: 'POST',
  ...
  useEffect(() => {
    if (plan && plan.city && plan.startDate) {
      ...
      fetch('https://travel-planner-api-623573920079.asia-east1.run.app/api/weather', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
